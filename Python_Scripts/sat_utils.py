...
def make_translate(cnf: ClueCNF):
...
def translate(cnf: ClueCNF, uniquify: bool = False):
...
class Q:
	...
	def __eq__(self, n: int):  # pyright: ignore[reportIncompatibleMethodOverride]
		return (self <= n) + (self >= n)

	def __ne__(self, n: Any):  # pyright: ignore[reportIncompatibleMethodOverride]
